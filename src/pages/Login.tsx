      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-safety-gray">
            Sign in to your SafetyPro account
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  id="remember"
                  className="w-4 h-4 text-safety-blue border-gray-300 rounded focus:ring-safety-blue"
                />
                <label htmlFor="remember" className="text-sm text-safety-gray">
                  Remember me
                </label>
              </div>
              <Link
                to="/forgot-password"
                className="text-sm text-safety-blue hover:text-safety-darkBlue transition-colors"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-safety-blue hover:bg-safety-darkBlue text-white font-semibold rounded-lg transition-colors"
              disabled={isLoading}
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-safety-gray">Or continue with</span>
            </div>
          </div>
        ...
        {/* Footer */}
        <p className="text-center text-sm text-safety-gray mt-6">
